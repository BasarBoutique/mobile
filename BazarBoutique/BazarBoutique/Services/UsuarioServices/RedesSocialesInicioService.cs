...
namespace BazarBoutique.Services.UsuarioServices
{
    public class RedesSocialesInicioService : IRedesSocialesInicioService
    {
        ...
        public async Task<bool> AutenticacionGoogle(string IdToken)
        {

            var Token = new JObject(
                new JProperty("idToken", IdToken)
            );
            ...
            Uri RequestUri = new Uri("https://monolith-stage.herokuapp.com/api/v2/auth/login/google");
